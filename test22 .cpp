...
void test22::consumer()
{
	...
	int priority=sched_get_priority_max(SCHED_FIFO); // We will use it to change our policy to FIFO 
	int result = sched_setscheduler(0, SCHED_FIFO, priority); // FIFO Policy
